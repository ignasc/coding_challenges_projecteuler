// The four adjacent digits in the 1000-digit number below, that have the highest product are 9x9x8x9=5832. Find the 13 adjacent numbers that have the highest product. What is their product?
...
function formatResult(originalDigit, product, digits, sequenceLength){
    ...
    console.log("-------------------------------------------------------------")
    console.log("The " + sequenceLength + " adjacent numbers that have the highest product are " + digits + " and their product is:")
    console.log(product)
}
...
function findProductOfAdjacentNumbers(number, length){
    ...
    for(let i = 0; i < digit.length; i++){
        ...
        product = productOfDigits(digitToTest)
...
// run solution
findProductOfAdjacentNumbers(longDigit, 13)
